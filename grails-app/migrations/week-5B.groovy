databaseChangeLog = {
    ...
    changeSet(author: "Kevin (generated)", id: "1462242355836-1") {
    ...
    changeSet(author: "Kevin (generated)", id: "1462242355836-2") {
        addColumn(tableName: "quote") {
            column(name: "attribution_id", type: "bigint")
        }
    }

    changeSet(author: "Kevin (generated)", id: "1462242355836-3") {
